        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-black/20 p-8 rounded-lg border-l-4 border-amber-500 flex flex-col animate-pulse hover:animate-none items-center text-center">
              ...
              <p className="mb-2">contact@artbyleso.com</p>
              <p>info@artbyleso.com</p>
            </div>
            ...
            <div className="bg-black/20 p-8 rounded-lg border-l-4 border-amber-500 flex flex-col animate-pulse hover:animate-none items-center text-center">
              ...
              <h3 className="text-xl font-bold text-amber-400 mb-3">Social Media</h3>
              <div className="flex space-x-4 justify-center">
                <Link
                  href="https://instagram.com/artbyleso"
                  target="_blank"
                ...
                <Link
                  href="https://twitter.com/artbyleso"
                  target="_blank"
                  className="text-2xl text-amber-400 hover:text-amber-300 transition-colors"
                >
                  <FaTwitter />
                ...
                <Link
                  href="https://facebook.com/artbyleso"
                  target="_blank"
                  className="text-2xl text-amber-400 hover:text-amber-300 transition-colors"
                >
                  <FaFacebook />
                ...
                <Link
                  href="https://linkedin.com/in/artbyleso"
                  target="_blank"
                  className="text-2xl text-amber-400 hover:text-amber-300 transition-colors"
                >
                  <FaLinkedin />
